...
public class FixedSeparatorMessageTokenizer implements MessageTokenizer<Command> {
    ...
    */
   public synchronized Command nextMessage() {
      String message = null;
    ...
    */
   public ByteBuffer getBytesForMessage(Command msg)  throws CharacterCodingException {
      StringBuilder sb = new StringBuilder(msg.unite());
